...
const UpdateAppointment: React.FC<UpdateAppointmentProps> = ({ appointmentId, email, phone_number }) => {
    ...
    useEffect(() => {
        const fetchVeterinarians = async () => {
            if (selectedSlot) {
                try {
                    const response = await axios.get(`${BASE_API}/users/veterinarian/${selectedSlot.slot_id}`);
    ...
    const handleNextClick = () => {
        if (selectedSlot && selectedVetId) {
            ...
            const updateDTO = {
                ...
                email: email || null,
                veterinarian_id: selectedVetId || null,
                phone_number: phone_number || null,
            };
            console.log("update",updateDTO)
            axios.patch(`${BASE_API}/appointments/${appointmentId}`, updateDTO)
                .then(response => {

                    console.log('Update appointment created:', response.data);
    ...
    const handleVeterinarianChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        <div className="d-flex flex-grow-1 align-items-center">
            <div className="container-fluid">
                ...
                <div className="col-md-7">
                    ...
                    {selectedSlot && (
                        <div className="veterinarian-dropdown">
                            <label htmlFor="veterinarian-select">Select Veterinarian:</label>
                            <select
                                ...
                                value={selectedVetId || ""}
                            >
                                <option value="" disabled>Select a veterinarian</option> {/* Default prompt */}
                    ...
                    <button className="btn btn-primary mt-3 mb-1" onClick={handleNextClick}
                            disabled={!selectedSlot || !selectedVetId}>
                        Update
                    </button>
